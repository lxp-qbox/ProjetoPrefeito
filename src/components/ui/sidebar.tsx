...
const sidebarMenuButtonVariants = cva(
  cn(
    ...
    "[&>svg]:text-sidebar-foreground/80 hover:[&>svg]:text-primary",
    "data-[active=true]:[&>svg]:!text-blue-500",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground/80 hover:[&>svg]:text-primary",
        "after:absolute after:-inset-2 after:md:hidden",
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:[&>svg]:!text-blue-500 md:opacity-0",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "peer-hover/menu-button:[&>svg]:text-primary peer-data-[active=true]/menu-button:[&>svg]:!text-blue-500",
      "peer-data-[size=sm]/menu-button:top-1",
      "peer-data-[size=default]/menu-button:top-1.5",
      "peer-data-[size=lg]/menu-button:top-2.5",
      "group-data-[collapsible=icon]:hidden",
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-transparent focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground/80 hover:[&>svg]:text-primary data-[active=true]:[&>svg]:!text-blue-500",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
